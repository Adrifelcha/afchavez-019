...
\institute{Faculty of Psychology, National Autonomous University of Mexico (UNAM)\\ Department of Cognitive Sciences, University of California Irvine} % Institution(s)
...
\begin{figure}
\includegraphics[width=0.55\linewidth]{Figures/MirrorEffect.png}
\end{figure}
...
\setbeamercolor{item projected}{fg=white,bg=Purple}
\begin{itemize}
\item Are the Hit and FA rates different?\\
\end{itemize}
\begin{center}
\begin{tabular}{ccc}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.8\linewidth]{Figures/4_Contaminant.pdf}
\end{tabular}
\end{center}
...
\small{\rmfamily{This project was supported by PAPIIT-UNAM (). Thanks to Alex Etz, J. M. Niño, Manuel Villarreal and José Luis Baroja for their input and help. \textbf{Website:} \href{www.bouzaslab25.com}{www.bouzaslab25.com}.\\
