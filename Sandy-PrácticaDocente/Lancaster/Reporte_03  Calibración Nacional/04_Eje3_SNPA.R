...
col_sk3 <- ifelse(skill_e3_Lancaster<0.3, "brown4", ifelse(skill_e3_Lancaster<0.7,"gold3","darkseagreen3"))
q3 <- c("H301","H302","H303","H304","H305","H306","H307","H308","H309","H310","H311","H312", "H313")
valor_label <- 13.9
valor_dot <- 13.9
barplot(rev(skill_e3_Lancaster), horiz=TRUE, ann=FALSE, axes=FALSE, xlim=c(0,1), space=0.1, col=rev(col_sk3), ylim=c(1,15),
        panel.first = 
...
col_sk3 <- ifelse(skill_e3_Sexto<0.3, "brown4", ifelse(skill_e3_Sexto<0.7,"gold3","darkseagreen3"))
q3 <- c("H301","H302","H303","H304","H305","H306","H307","H308","H309","H310","H311","H312", "H313")
valor_label <- 13.9
valor_dot <- 13.9
barplot(rev(skill_e3_Sexto), horiz=TRUE, ann=FALSE, axes=FALSE, xlim=c(0,1), space=0.1, col=rev(col_sk3), ylim=c(1,15),
        panel.first = 
          c(lines(c(0.1,0.1),c(-0.07,0.97),lwd=1,lty=3, col="black"),lines(c(0.2,0.2),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.3,0.3),c(-0.07,0.97),lwd=3,lty=1, col="gold3"),lines(c(0.4,0.4),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.5,0.5),c(-0.07,0.97),lwd=1,lty=3, col="black"),lines(c(0.6,0.6),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.7,0.7),c(-0.07,0.97),lwd=3,lty=1, col="darkseagreen3"),lines(c(0.8,0.8),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.9,0.9),c(-0.07,.97),lwd=1,lty=3, col="black"),lines(c(1,1),c(-0.07,0.97),lwd=1,lty=3, col="black")))    
mtext(side=1, text = "Dominio de la habilidad", line=3, cex=1.3, f=2)
mtext(side=2, text = "Habilidad", line=1, cex=1.8, f=2)
mtext(side=3, text = "Eje 3: Sentido Numérico y Pensamiento Algebraico", line=1.5, cex=2, f=2)
...
col_sk3 <- ifelse(skill_e3_Quinto<0.3, "brown4", ifelse(skill_e3_Quinto<0.7,"gold3","darkseagreen3"))
q3 <- c("H301","H302","H303","H304","H305","H306","H307","H308","H309","H310","H311","H312", "H313")
valor_label <- 13.9
valor_dot <- 13.9
barplot(rev(skill_e3_Quinto), horiz=TRUE, ann=FALSE, axes=FALSE, xlim=c(0,1), space=0.1, col=rev(col_sk3), ylim=c(1,15),
        panel.first = 
          c(lines(c(0.1,0.1),c(-0.07,0.97),lwd=1,lty=3, col="black"),lines(c(0.2,0.2),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.3,0.3),c(-0.07,0.97),lwd=3,lty=1, col="gold3"),lines(c(0.4,0.4),c(-0.07,0.97),lwd=1,lty=3, col="black"),
            lines(c(0.5,0.5),c(-0.07,0.97),lwd=1,lty=3, col="black"),lines(c(0.6,0.6),c(-0.07,0.97),lwd=1,lty=3, col="black"),
...
#col_sk3 <- ifelse(skill_e3_Quinto>0.5, "palegreen3", "palegreen4")
col_sk3 <- ifelse(skill_e3_Quinto<0.3, "brown4", ifelse(skill_e3_Quinto<0.7,"lightgoldenrod","palegreen3"))
q3 <- c("H301","H302","H303","H304","H305","H306","H307","H308","H309","H310","H311","H312", "H313")
valor_label <- 13.9
valor_dot <- 13.9
barplot(rev(skill_e3_Quinto), horiz=TRUE, ann=FALSE, axes=FALSE, xlim=c(0,1), space=0.1, col=rev(col_sk3), ylim=c(1,15),
...
for(i in 1:length(seq(1,13,1))){
  text(0.04,valor_label, paste(q3[i]), f=2, cex=1.2)
  col_comp <- ifelse(skill_e3_Quinto[i]>skill_e3_Sexto[i], "darkgreen", "red")
  points(skill_e3_Sexto[i],valor_dot, pch=15, cex=2, lwd=4, col=col_comp)
  text(0.19,valor_dot, paste("Sexto año: ", round(skill_e3_Sexto[i],3)), f=2, cex=0.8, col=col_comp)
  text(skill_e3_Quinto[i]+.06,valor_label, paste(round(skill_e3_Quinto[i],3)), f=2, cex=1.2)
  valor_dot <- valor_dot - 1.1
  valor_label <- valor_label - 1.1}
