...
\chead{} % Centre header
\rhead{\small\ifdef{\assignmentAuthorName}{Baroja, J.L.; Chávez, A.F; Hernández C.A.}{\ifdef{\assignmentDueDate}{Fecha de entrega:\ \assignmentDueDate}{}}} % Right header; output the author name if one was set, otherwise the 
