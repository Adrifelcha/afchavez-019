...
\newlength{\twocolwid}
\newlength{\threecolwid}
\setlength{\paperwidth}{119cm} % Width 150 cm  [Max 96in - 244 cm]
\setlength{\paperheight}{88cm} % Heighth 120.22 [Max 48 - 121 m]
...
\node[anchor=north west] at ([shift={(1cm,-1cm)}]current page.north west)
    {\includegraphics[width=8cm]{Figures/UNAMiwi.jpg}};
\node[anchor=north east] at ([shift={(-1cm,-1cm)}]current page.north east)
    {\includegraphics[width=8.6cm, height=10.1cm]{Figures/Lab25.png}};
\end{tikzpicture}
