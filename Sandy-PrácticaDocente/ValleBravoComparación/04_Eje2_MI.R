...
#col_sk2 <- ifelse(skill_Secu_Lancaster>0.5, "lightsalmon1", "lightsalmon4")
col_sk2 <- ifelse(skill_Secu<0.3, "brown4", ifelse(skill_Secu<0.7,"gold3","darkseagreen3"))
q2 <- c("H201","H202","H203","H204","H205","H206","H207","H208","H209","H210")
valor_label <- 10.6
valor_dot <- 10.6
barplot(rev(skill_Secu), horiz=TRUE, ann=FALSE, axes=FALSE, xlim=c(0,1), space=0.1, col=rev(col_sk2), ylim=c(0,12),
        panel.first = 
