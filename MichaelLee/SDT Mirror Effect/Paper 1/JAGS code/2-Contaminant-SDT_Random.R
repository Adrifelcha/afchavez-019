...
model{
  ...
  # Observed counts
    ...
    thetah_A[i] <- equals(z[i],1)*phi((d_A[i]/2)-c_A[i])+equals(z[i],0)*pi
    thetaf_A[i] <- equals(z[i],1)*phi((-d_A[i]/2)-c_A[i])+equals(z[i],0)*pi
    thetah_B[i] <- equals(z[i],1)*phi((d_B[i]/2)-c_B[i])+equals(z[i],0)*pi
    thetaf_B[i] <- equals(z[i],1)*phi((-d_B[i]/2)-c_B[i])+equals(z[i],0)*pi
